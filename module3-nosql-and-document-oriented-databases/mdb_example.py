...
# MongoDb was different than PostgreSQL because it wasn't relational and didn't use SQL.
# I think it was definitely easier to use, since it is more like writing python 
# and I have a lot more experience with python than i do with SQL 
